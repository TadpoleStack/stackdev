...
module.exports = {
    ...
    head: [
        ...
        [
            'script',
            { src: 'https://cdn.bootcss.com/Swiper/4.5.0/js/swiper.min.js' }
        ], //swiper.js---cdn
        [
            'script',
            { src: 'https://cdn.bootcss.com/Swiper/4.5.0/css/swiper.min.css' }
        ], //swiper.css---cdn
        [
            'script',
            { src: 'https://cdn.bootcss.com/animate.css/3.7.2/animate.min.css' }
        ] //animate.css---cdn
    ],
    markdown: {
        lineNumbers: true
